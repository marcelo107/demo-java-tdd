...
public class ConverterSvc {
   ...
   * //example json response from coindesk api: { "time": { "updated":
   * "Oct 15, 2020 22:55:00 UTC", "updatedISO": "2020-10-15T22:55:00+00:00",
   * "updateduk": "Oct 15, 2020 at 23:55 BST" }, "disclaimer":
   * "This data was produced from the CoinDesk Bitcoin Price Index (USD)",
   * "chartName": "Bitcoin", "bpi": { "USD": { "code": "USD", "symbol": "&#36;",
   * "rate": "11,486.5341", "description": "United States Dollar", "rate_float":
   * 11486.5341 }, "GBP": { "code": "GBP", "symbol": "&pound;", "rate":
   * "8,900.8693", "description": "British Pound Sterling", "rate_float":
   * 8900.8693 }, "EUR": { "code": "EUR", "symbol": "&euro;", "rate":
   * "9,809.3278", "description": "Euro", "rate_float": 9809.3278 } } }
   */
    ...
    try (
      ...
      case 200:
        ...
        JsonObject jsonObject = new JsonParser().parse(json)
            .getAsJsonObject();
        String n = jsonObject.get("bpi").getAsJsonObject()
            .get(currency.toString()).getAsJsonObject().get("rate_float")
            .getAsString();
        rate = Double.parseDouble(n);
